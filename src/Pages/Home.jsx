...
const Home = () => {
  ...
  return (
    <div className="relative w-full h-[95vh] overflow-hidden bg-gray-600">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-start h-full px-5 lg:px-10">
        ...
        <div className="lg:w-1/2 w-full text-left mb-10 lg:mb-0 lg:pl-5">
          <h1 className="lg:text-5xl font-bold mb-6 text-white">
            {slides[currentSlide].title}
          </h1>
          <p className="text-lg lg:text-2xl mb-10 text-white">
